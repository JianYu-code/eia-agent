...
COEFF_DATA = [
    ...
    # === 重点行业 ===
    ("水泥", "水泥制造", "新型干法窑", "颗粒物", 45, "kg/t熟料", "系数手册", "未含除尘"),
    ("水泥", "水泥制造", "新型干法窑", "NOx", 1.6, "kg/t熟料", "系数手册", "低氮燃烧后"),
    ("水泥", "水泥制造", "新型干法窑", "SO₂", 0.2, "kg/t熟料", "系数手册", ""),
    ("钢铁", "炼铁", "烧结机", "颗粒物", 12, "kg/t烧结矿", "系数手册", "未含除尘"),
    ("钢铁", "炼铁", "烧结机", "SO₂", 2.0, "kg/t烧结矿", "系数手册", ""),
    ("电镀", "表面处理", "电镀", "COD", 60, "g/m²镀层", "系数手册", ""),
    ("养殖", "生猪养殖", "规模化", "COD", 35, "kg/(头·a)", "系数手册", ""),
    ("养殖", "生猪养殖", "规模化", "氨氮", 2.5, "kg/(头·a)", "系数手册", ""),
]
